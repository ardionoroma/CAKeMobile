...
//    }
    ...
    private void bacaData(){
        ...
        for (int i = 0; i < cursor.getCount(); i++){
            ...
            map.setId_company(cursor.getString(0));
            map.setName_company(cursor.getString(1));
            map.setDesc_company(cursor.getString(2));
            map.setImage(cursor.getString(3));
            map.setStock_price(cursor.getString(4));
            map.setBeta(Float.parseFloat(cursor.getString(5)));
            map.setUsing_dollar(Integer.parseInt(cursor.getString(6)));
            map.setCurrent_asset1(cursor.getString(7));
            map.setCurrent_asset2(cursor.getString(8));
            map.setCurrent_l1(cursor.getString(9));
            map.setCurrent_l2(cursor.getString(10));
            map.setOutstanding_share(cursor.getString(11));
            map.setTotal_equity(cursor.getString(12));
            map.setNet_income(cursor.getString(13));
            map.setCapital_expenditure(cursor.getString(14));
            map.setDepreciation(cursor.getString(15));
            map.setCwc(cursor.getString(16));
            map.setDividend_payment(cursor.getString(17));
            map.setCapm(cursor.getString(18));
            map.setDividend_payout(cursor.getString(19));
            map.setRetention_ratio(cursor.getString(20));
            map.setTotal_asset(cursor.getString(21));
            map.setTotal_l12(cursor.getString(22));
            map.setInterest_expense(cursor.getString(23));
            map.setEbit(cursor.getString(24));
            map.setFcff(cursor.getString(25));
            map.setCost_debt(cursor.getString(26));
            map.setWacc(cursor.getString(27));
            map.setReturn_capital(cursor.getString(28));
            map.setExpected_growth_fcff(cursor.getString(29));
            map.setIntrinsik_fcff(cursor.getString(30));
            map.setEps(cursor.getString(31));
            map.setNew_debt_issued(cursor.getString(32));
            map.setDebt_repayment(cursor.getString(33));
            map.setFcfe(cursor.getString(34));
            map.setReturn_equity(cursor.getString(35));
            map.setExpected_growth_fcfe(cursor.getString(36));
            map.setIntrinsik_fcfe(cursor.getString(37));
            map.setInfo(cursor.getString(38));
            map.setId_sector(Integer.parseInt(cursor.getString(39)));
            map.setUpdated_using(cursor.getString(40));
            map.setUpdated_at(cursor.getString(41));
